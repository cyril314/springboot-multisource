	...
	methods: {
        ...
        getList: function(){
        	...
        	$.ajax({
        		...
        		type: "POST",
        		url: httpurl+'casehandle/list?showCount='+this.showCount+'&currentPage='+this.currentPage,
    	...
    	goAdd: function (){
    		 ...
    		 diag.Drag=true;
    		 diag.Title ="案件办理";
    		 diag.URL = '../../fhoa/casehandle/casehandle_edit.html';
    		 diag.Width = 600;
    		 diag.Height = 546;
    		...
    		swal({
                ...
                if (willDelete) {
                	...
                	$.ajax({
            			...
            			type: "POST",
            			url: httpurl+'casehandle/delete',
            	    	data: {CASE_ID:id,tm:new Date().getTime()},
            			dataType:'json',
            			success: function(data){
            				 if("success" == data.result){
    				...
    				if(str==''){
    					...
    					if(msg == '确定要删除选中的数据吗?'){
    						...
    						$.ajax({
    							...
    							type: "POST",
    							url: httpurl+'casehandle/deleteAll?tm='+new Date().getTime(),
    					    	data: {DATA_IDS:str},
    							dataType:'json',
    							success: function(data){
    								if("success" == data.result){
