...
public class DbFH {
    ...
    public static Object[] getTables(PageData pd) throws ClassNotFoundException, SQLException {
        ...
        if ("oracle".equals(dbType)) {
            databaseName = pd.getString("dbUser").toUpperCase();
        }
    ...
    public static Object[] getTables() throws ClassNotFoundException, SQLException {
        ...
        if ("oracle".equals(dbType)) {
            databaseName = YmlUtil.get("dbUser").toUpperCase();
        }
     ...
     * @throws SQLException
     */
    public static Connection getFHCon() throws SQLException, ClassNotFoundException {
        String dbType = YmlUtil.get("dbType");      //数据库类型
     ...
     * @throws SQLException
     */
    public static Connection getFHCon(PageData pd) throws SQLException, ClassNotFoundException {
        String dbType = pd.getString("dbType");     //数据库类型
    ...
    class DbBackUpCallable implements Callable<Object> {
        ...
        public Object call() {
            try {
                ...
                String dbtype = YmlUtil.get("dbtype");                //数据库类型
                String username = YmlUtil.get("username");            //用户名
                String password = YmlUtil.get("password");            //密码
                String address = YmlUtil.get("dbAddress");            //数据库连接地址
                String databaseName = YmlUtil.get("databaseName");    //数据库名
    ...
    public static void executeUpdateFH(String sql) throws ClassNotFoundException, SQLException {
        try {
            ...
            System.out.println(String.format("=============执行SQL失败============= ,error: %s", se.getMessage()));
        }
    }
    ...
    public static Map<String, String> getDBParameter() {
        ...
        fhmap.put("remoteDB", YmlUtil.get("remoteDB"));//是否远程备份数据库 yes or no
        return fhmap;
    }
}