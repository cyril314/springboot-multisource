...
public class HeadController extends BaseController {
    ...
    public Object getList() throws Exception {
        ...
        if (null != user) {
            ...
            String sysName = IniFileUtil.readCfgValue(infFilePath, "SysSet1", Const.SYSNAME, "FitAdmin");        //系统名称
    ...
    public Object sysSet() throws Exception {
        ...
        pd.put("sysName", IniFileUtil.readCfgValue(infFilePath, "SysSet1", Const.SYSNAME, "FitAdmin"));            //系统名称
